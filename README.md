...
## [LIVE URL](https://sudoku-sadrita.vercel.app/)
...
---
### Inspo: 
For this project, my inspo was that I like to solve Sudoku every time I open newspaper in my home and I love to do that since childhood and that's the initial inspiration to start this project that why can't I build it for online, so I start this project.
...
**Smart Grid Generation:** Uses a backtracking algorithm to ensure every puzzle is randomized and solvable.
